...
class GraphData:
    ...
    def load_graph(self, name, target_ratio, perturbation_rate):
        """
        Load the graph data from a pickle file.
        """
        file_path = os.path.join(self.save_dir, f"{name}_{target_ratio}_{perturbation_rate}.pkl")
        if os.path.exists(file_path):
            ...
            data = get_data(self.root, dataset_name=name, target_ratio=target_ratio, perturb_rate=perturbation_rate)
